...
if __name__ == "__main__":
    ...
    with start_run_with_exception_logging(
        ...
        model = HybridDenistyRegressionModel(
            ...
            parameter_kwds=params["parameter_kwds"],
            base_distribution=params["base_distribution"],
            base_distribution_kwds=params["base_distribution_kwds"],
            base_parameter_kwds=params["base_parameter_kwds"],
        )
