...
from mctm.distributions import __get_multivariate_normal_lambda__
...
# model, hist = pipeline(
#     __get_multivariate_normal_lambda__, dist_keywords, output_shape, ds_train_encoded, lambda x: x
# )
